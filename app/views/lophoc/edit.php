<style>
    ...
    .form-card h3 { margin-bottom: 24px; color: white; background: #ffc107; color: #212529; padding: 14px 20px; border-radius: 6px; margin: -30px -30px 24px; }
    ...
    .form-group input:focus, .form-group textarea:focus { border-color: #ffc107; box-shadow: 0 0 0 3px rgba(255,193,7,0.2); }
...
<div class="form-card">
    ...
    <form action="/lophoc/update/<?php echo $lophoc['id']; ?>" method="POST">
        ...
        <div class="form-group">
            <label>Ghi chú</label>
            <textarea name="GhiChu" rows="3"><?php echo htmlspecialchars($lophoc['GhiChu'] ?? ''); ?></textarea>
        </div>
